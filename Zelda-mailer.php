...
<head>
  <meta charset="utf-8">
<!-- Page title -->
<title> | Log In | Mailer Inbox By Zeldaus🚀</title>
...
<span aria-hidden="true" class="octicon octicon-link"></span></a>Welcome To Mailer 🚀 <code style="font-size:12px;color:#0bc4d1;">v1.0 </code> </h1>
<p style="font-size:13px;color:#ffffff;">
 <code style="font-size:12px;color:#0bc4d1;"> Function Power Mailer Inbox v1.0</code>
<br>Unlimited Sending to Inbox Bitch ✉
<br>New Design 🎨 MutherFucker
<br>Random Email Automaticly Change Like your face 🎭
<br>Bye Little Boy 🚬
</p>
...
<div>
	 ...
	 <p></p><p></p>
<p style="font-size:12px;color:#ffffff;">&copy;CODED BY <? echo $MyRight ;?></p>
<br> <br>
</div>
</div>
</body>
...
if (isset($_POST['access_password'])) {
  ...
  if (!USE_USERNAME && !in_array($pass, $zeldaprotect)
  || (USE_USERNAME && ( !array_key_exists($login, $zeldaprotect) || $zeldaprotect[$login] != $pass ) ) 
  ) {
  ...
  $found = false;
  foreach($zeldaprotect as $key=>$val) {
...
<head>
  <meta charset="utf-8">
<!-- Page title -->
<title>Mailer Inbox By Zeldaus</title>
<!-- Gotsta have that favicon-->
<link rel="icon" type="image/png" href="https://cdn0.iconfinder.com/data/icons/kameleon-free-pack-rounded/110/Paper-Plane-512.png" />
<link rel="shortcut icon" type="image/x-icon" href="https://cdn0.iconfinder.com/data/icons/kameleon-free-pack-rounded/110/Paper-Plane-512.png" />
<meta name="viewport" content="width=480">
...
<div align="center"><h2 style="color:#ffffff;">
	<a id="user-content-installation" class="anchor" href="#installation" aria-hidden="true">
<span aria-hidden="true" class="octicon octicon-link"></span></a> Zelda Mailer Inbox <code style="font-size:12px;color:#0bc4d1;">v1.0 </code> </h2>
<p style="font-size:12px;color:#ffffff;"> This Script Has Been Made With Brain & a Lot of Cofee ☕ </p>
<div style="font-size:14px;color:#ffffff;" >
<a href="?home" class="Zelda215-B"> Home </a> 
|| <a href="?logout" class="Zelda215-B"> Logout</a></div>
<p></p>
...
if($Misterklio != "") {
 ...
 ///// RANDOM SERVICE
  ...
  <link href="http://netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.min.css" rel="stylesheet" />
	...
	$Number--;
	if($ZeldaMailerInbox == "MailerInbox")
